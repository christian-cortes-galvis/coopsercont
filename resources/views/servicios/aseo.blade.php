		...
		<div class="my-4 text-center">
			<div class="row justify-content-center g-3">
				<div class="col-12 col-md-6">
					<img src="{{ asset('institucional/aseo1.jpg') }}" class="img-fluid rounded border img-infraestructura" alt="Aseo 1">
				</div>
				<div class="col-12 col-md-6">
					<img src="{{ asset('institucional/aseo2.png') }}" class="img-fluid rounded border img-infraestructura" alt="Aseo 2">
				</div>
			</div>
		</div>
		{{-- DESCRIPCIÓN --}}
